 ...
 * The Presenter Responsible for transferring commands between the View and the Model
 * 
 * 
...
public interface Presenter  {
	...
	/**
	 * set model method - model will connected to Presenter
	 * @param m - any type of model
	 */
	void setModel(Model m);
	/**
	 * set view method - view will connected to Presenter
